...
<div class="main_column column">
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div class = "main column column" id="CroppingContainer" style="width:100%; max-height:600px; background-color:#FFF; /*margin-left: 2px;*/ position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="CropImageForm" style="width:120px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return checkCoords();">
	                ...
	                <input type="submit" value="Save" style="width:120px; height:30px;"   />
	            </form>
	        </div>

	        <div id="CropImageForm2" style="width:120px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload.php" method="post" onsubmit="return cancelCrop();">
	                <input type="submit" value="Cancel Crop" style="width:120px; height:30px;"   />
	            </form>
	        </div>            
